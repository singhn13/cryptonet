...
const ServiceCard = ( {color, title, icon, subtitle} ) => (
    <div className="flex flex-row justify-start items-center white-glassmorphism p-4 m-2 cursor-pointer hover:shadow-xl">
        ...
        <div className="ml-5 flex flex-col flex-1">
            ...
            <p className="mt-0 text-white text-sm">{subtitle}</p>
        </div>
    </div>
)
    ...
    return (
        <div className="flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services">
            ...
            <div className="flex-2 flex-col justify-start items-center">
                ...
                subtitle="We offer the best exchange rates across the web. You can always count on us."
                />
                <ServiceCard 
                color="bg-[#f84550]"
                title="Fastest Transactions"
                icon={<RiHeart2Fill fontSize={21} className="text-white" />}
                subtitle="Transactions that take a couple of seconds to complete."
                />
            </div>
        </div>
    );
